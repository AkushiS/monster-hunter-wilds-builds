  ...
  setTimeout(() => {
    ...
    switch (weapon) {
      case "Arc":
        builds = `
          <div class="build-card">
            ...
            <p>PS : C'est un build qui fonctionne avec une arme élémentaire. Pour profiter pleinement de ce build, il vous faudra avoir au minimum 2 bonus de renforcement avec Boost élémentaire.</p>
          </div>
        `;
        break;
      ...
      case "Corne de chasse":
        builds = `
          <div class="build-card">
            ...
            <p>PS : C'est un build polyvalent qui fonctionne aussi bien avec une arme en élémentaire, en affliction qu'en attaque.</p>
          </div>
        `;
        break;
      ...
      case "Fusarbalète léger":
        builds = `
          <div class="build-card">
            ...
            <p>PS : C'est un build qui fonctionne avec une arme élémentaire.</p>
          </div>
        `;
        break;
      ...
      case "Insectoglaive":
        builds = `
          <div class="build-card">
            ...
            <p>PS : C'est un build polyvalent qui fonctionne aussi bien avec une arme élémentaire, en affliction qu'en attaque.</p>
          </div>
        `;
        break;
      ...
      case "Morpho-hache":
        builds = `
          <div class="build-card">
            <h3>Builds Morpho DPS</h3>
            <a href="Images/Morpho-DPS.png" target="_blank">
              <img src="Images/Morpho-DPS.png" alt="Build Morpho DPS">
            </a>
            ...
            <p>PS : vous pouvez obtenir davantage de tranchant si vous disposez de Tranchant EX dans les bonus de renforcement de l’arme.</p>
            <p>PS : C'est un build principalement conçu pour une arme élémentaire, mais il reste viable avec une arme en affliction ou en attaque. Dans ce cas, le talent Union ne sera pas utile et pourra être remplacé par un autre talent.</p>
          </div>
        `;
        break;
      ...
      case "Volto-hache":
        builds = `
          <div class="build-card">
            ...
            <p>PS : C'est un build qui fonctionne avec une arme élémentaire. Il est fortement conseillé d'avoir un maximum de bonus de renforcement en Boost élémentaire, soit jusqu'à 4 lignes au maximum.</p>
          </div>
        `;
        break;
